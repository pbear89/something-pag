  ...
  <div class="side-navbar-wrapper">
    <div class="sidenav-header d-flex align-items-center justify-content-center">
      <div class="sidenav-header-inner text-center">
          <img src="{{{ URL::asset('img/avatar.jpg')}}}" alt="person" class="img-fluid rounded-circle">
        <h2 class="h5 text-uppercase">Jecsy Zambrano</h2><span class="text-uppercase">Sensual Abogada</span>
      </div>
      <div class="sidenav-header-logo"><a href="index.html" class="brand-small text-center"> <strong>J</strong><strong class="text-primary">Z</strong></a></div>
    </div>
    <div class="main-menu">
