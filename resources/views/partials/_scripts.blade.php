<!--   Core JS Files   -->
    ...
    <!-- Share Library etc -->
    <script src="{{{ URL::asset('js/plugins/jquery.sharrre.js')}}}" type="text/javascript"></script>
    <!-- Control Center for Now Ui Kit: parallax effects, scripts for the example pages etc -->
    <script src="{{{ URL::asset('js/now-ui-kit.js?v=1.1.0')}}}" type="text/javascript"></script>
