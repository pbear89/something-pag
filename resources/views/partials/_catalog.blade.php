            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="team-player">
                        <img src="img/avatar.jpg" alt="Thumbnail Image" class="rounded img-fluid img-raised">
                        <h4 class="title">NOMBRE PRODUCTO -> Romina Hadid</h4>

                        <p class="category text-primary">CATEGORIA -> Model</p>
